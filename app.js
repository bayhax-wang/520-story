...
function renderEnding(ctx,W,H,t,p){
  ...
  drawCenterText(ctx,W,H,'520快乐 ❤️\n\n从此，每一天都是我们的故事',{color:'rgba(255,240,230,'+a+')',lineHeight:38,font:Math.min(W*.05,22)+'px "PingFang SC",sans-serif'});
  if(t>2){var gl=document.getElementById('game-links');if(gl)gl.style.display='block';}
}
